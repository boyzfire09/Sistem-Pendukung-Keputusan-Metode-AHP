...
public class BlurWarna6 extends JPanel {
    private int roundness = 20;
    private Color panelColor = new Color(255, 255, 255, 120); // Putih blur/transparan
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            BlurWarna4 panel = new BlurWarna4();
            panel.setBounds(80, 80, 320, 150);
            panel.setPanelColor(new Color(255, 255, 255, 120)); // putih blur
            panel.setRoundness(25);

            JLabel label = new JLabel("Panel Putih Blur", JLabel.CENTER);
            label.setForeground(Color.BLACK); // Karena latarnya putih, teks gelap lebih terlihat
