...
public class BlurWarna3 extends JPanel {
    private int roundness = 30;
    private Color panelColor = new Color(0, 204, 204, 100); // warna transparan
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            BlurWarna3 panel = new BlurWarna3();
            panel.setBounds(80, 80, 320, 150);
            panel.setPanelColor(new Color(0, 204, 204, 100)); // abu abu transparan
