...
public class BlurWarna4 extends JPanel {
    private int roundness = 30;
    private Color panelColor = new Color(255, 94, 77, 120); // orange warna transparan
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            panel.setPanelColor(new Color(255, 94, 77, 120)); // orange transparan
