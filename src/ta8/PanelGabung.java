...
public class PanelGabung extends JPanel {
    ...
    this.colorEnd = end;
    repaint(); // menggambar ulang panel dengan warna baru
}
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Membuat bentuk rounded rectangle
        Shape roundRect = new RoundRectangle2D.Double(0, 0, getWidth(), getHeight(),
                roundTopLeft, roundTopRight);
        g2.fill(roundRect);

       if (isHovered) {
    // Lapisan blur putih semi transparan
    g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.f)); // Transparansi garis
    g2.setColor(Color.WHITE); // Warna garis
    g2.draw(roundRect); // Menggambar garis outline
}
        g2.dispose();
    }
