...
public class BlurWarna5 extends JPanel {
    private int roundness = 30;
    private Color panelColor = new Color(204, 51, 255, 100); // ungu warna transparan
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            BlurWarna5 panel = new BlurWarna5();
            panel.setBounds(80, 80, 320, 150);
            panel.setPanelColor(new Color(204, 51, 255, 100)); // ungu transparan
